...
export default function AdminProfile({ autoEdit = false, onAutoEditConsumed }) {
  ...
  const profileStatus = resolveLocalAdminStatus({
    isActive: profile.isActive,
    connected,
    lastLogin: profile.lastLogin,
  })
  const profileStatusMeta = getAdminStatusMeta(profileStatus)
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <span
                            className={`inline-flex items-center gap-2 px-2 py-1 text-xs font-semibold rounded-full ${profileStatusMeta.wrap}`}
                          >
                            <span
                              className={`h-2 w-2 rounded-full ${profileStatusMeta.dot}`}
                            />
